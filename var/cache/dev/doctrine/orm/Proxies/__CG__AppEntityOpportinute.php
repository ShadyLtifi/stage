 ...
 */
class Opportinute extends \App\Entity\Opportinute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Opportinute' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Opportinute' . "\0" . 'NomFaculte', '' . "\0" . 'App\\Entity\\Opportinute' . "\0" . 'DateDebut', '' . "\0" . 'App\\Entity\\Opportinute' . "\0" . 'Datefin', '' . "\0" . 'App\\Entity\\Opportinute' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Opportinute' . "\0" . 'Titre'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Opportinute $proxy) {
    ...
    public function getNomFaculte(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomFaculte', []);

        return parent::getNomFaculte();
    }
    ...
    public function setNomFaculte(string $NomFaculte): static
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomFaculte', [$NomFaculte]);

        return parent::setNomFaculte($NomFaculte);
    }
