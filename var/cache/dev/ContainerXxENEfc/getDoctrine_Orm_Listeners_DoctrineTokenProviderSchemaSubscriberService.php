...
class getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['doctrine.orm.listeners.doctrine_token_provider_schema_subscriber'] = new \Symfony\Bridge\Doctrine\SchemaListener\RememberMeTokenProviderDoctrineSchemaSubscriber(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.authenticator.remember_me_handler.admin_fac'] ?? $container->load('getSecurity_Authenticator_RememberMeHandler_AdminFacService'));
            yield 1 => ($container->privates['security.authenticator.remember_me_handler.admin_esprit'] ?? $container->load('getSecurity_Authenticator_RememberMeHandler_AdminEspritService'));
            yield 2 => ($container->privates['security.authenticator.remember_me_handler.etudiant_esprit'] ?? $container->load('getSecurity_Authenticator_RememberMeHandler_EtudiantEspritService'));
            yield 3 => ($container->privates['security.authenticator.remember_me_handler.main'] ?? $container->load('getSecurity_Authenticator_RememberMeHandler_MainService'));
        }, 4));
    }
}
