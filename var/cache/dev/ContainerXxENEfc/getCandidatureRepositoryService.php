...
class getCandidatureRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CandidatureRepository.php';

        return $container->privates['App\\Repository\\CandidatureRepository'] = new \App\Repository\CandidatureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
