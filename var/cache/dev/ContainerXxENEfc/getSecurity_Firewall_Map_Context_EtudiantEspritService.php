 ...
 */
class getSecurity_Firewall_Map_Context_EtudiantEspritService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.firewall.map.context.etudiant_esprit' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.map.context.etudiant_esprit'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['debug.security.firewall.authenticator.etudiant_esprit'] ?? $container->load('getDebug_Security_Firewall_Authenticator_EtudiantEspritService'));
            yield 3 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($container->privates['security.authentication.trust_resolver'] ?? ($container->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), $b, 'etudiant_esprit', ($container->privates['App\\Security\\EtudiantAuthenticator'] ?? $container->load('getEtudiantAuthenticatorService')), NULL, NULL, ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, ($container->privates['security.event_dispatcher.etudiant_esprit'] ?? $container->getSecurity_EventDispatcher_EtudiantEspritService()), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('etudiant_esprit', 'security.user_checker', '.security.request_matcher.HiaUemK', true, false, 'security.user.provider.concrete.app_etudiantes_provider', 'etudiant_esprit', 'App\\Security\\EtudiantAuthenticator', NULL, NULL, [0 => 'remember_me', 1 => 'App\\Security\\EtudiantAuthenticator'], NULL));
    }
}
