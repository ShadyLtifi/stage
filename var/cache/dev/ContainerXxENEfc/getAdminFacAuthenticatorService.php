 ...
 */
class getAdminFacAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\AdminFacAuthenticator' shared autowired service.
     *
     * @return \App\Security\AdminFacAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'AdminFacAuthenticator.php';

        return $container->privates['App\\Security\\AdminFacAuthenticator'] = new \App\Security\AdminFacAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
