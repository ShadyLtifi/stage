 ...
 */
class getAdminEsAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\AdminEsAuthenticator' shared autowired service.
     *
     * @return \App\Security\AdminEsAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'AdminEsAuthenticator.php';

        return $container->privates['App\\Security\\AdminEsAuthenticator'] = new \App\Security\AdminEsAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
