 ...
 */
class getSecurity_Firewall_Map_Context_AdminEspritService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.firewall.map.context.admin_esprit' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.map.context.admin_esprit'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['debug.security.firewall.authenticator.admin_esprit'] ?? $container->load('getDebug_Security_Firewall_Authenticator_AdminEspritService'));
            yield 3 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($container->privates['security.authentication.trust_resolver'] ?? ($container->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), $b, 'admin_esprit', ($container->privates['App\\Security\\AdminEsAuthenticator'] ?? $container->load('getAdminEsAuthenticatorService')), NULL, NULL, ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, ($container->privates['security.event_dispatcher.admin_esprit'] ?? $container->getSecurity_EventDispatcher_AdminEspritService()), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('admin_esprit', 'security.user_checker', '.security.request_matcher.aeb3C1Q', true, false, 'security.user.provider.concrete.app_admines_provider', 'admin_esprit', 'App\\Security\\AdminEsAuthenticator', NULL, NULL, [0 => 'remember_me', 1 => 'App\\Security\\AdminEsAuthenticator'], NULL));
    }
}
