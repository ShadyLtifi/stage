...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AdminEspritController' => 'getAdminEspritControllerService',
            'App\\Controller\\AdminFacController' => 'getAdminFacControllerService',
            'App\\Controller\\CandidatureController' => 'getCandidatureControllerService',
            'App\\Controller\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\EtudiantEspritController' => 'getEtudiantEspritControllerService',
            'App\\Controller\\FrontController' => 'getFrontControllerService',
            'App\\Controller\\OpportinuteController' => 'getOpportinuteControllerService',
            'App\\Controller\\SecurityEsController' => 'getSecurityEsControllerService',
            'App\\Controller\\SecurityEtudiantController' => 'getSecurityEtudiantControllerService',
            'App\\Controller\\SecurityFaculteController' => 'getSecurityFaculteControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SK-rOZqiqi', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ne3fqJAjD8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('blH4jVaz-3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AdminEspritRepository' => ['privates', 'App\\Repository\\AdminEspritRepository', 'getAdminEspritRepositoryService', true],
            'App\\Repository\\AdminFacRepository' => ['privates', 'App\\Repository\\AdminFacRepository', 'getAdminFacRepositoryService', true],
            'App\\Repository\\CandidatureRepository' => ['privates', 'App\\Repository\\CandidatureRepository', 'getCandidatureRepositoryService', true],
            'App\\Repository\\EtudiantEspritRepository' => ['privates', 'App\\Repository\\EtudiantEspritRepository', 'getEtudiantEspritRepositoryService', true],
            'App\\Repository\\OpportinuteRepository' => ['privates', 'App\\Repository\\OpportinuteRepository', 'getOpportinuteRepositoryService', true],
        ], [
            'App\\Repository\\AdminEspritRepository' => '?',
            'App\\Repository\\AdminFacRepository' => '?',
            'App\\Repository\\CandidatureRepository' => '?',
            'App\\Repository\\EtudiantEspritRepository' => '?',
            'App\\Repository\\OpportinuteRepository' => '?',
        ])));
    ...
    /**
     * Gets the private '.service_locator.DWP.fe3' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_DWP_Fe3Service()
    {
        return $this->privates['.service_locator.DWP.fe3'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.firewall.map.context.admin_esprit' => ['privates', 'security.firewall.map.context.admin_esprit', 'getSecurity_Firewall_Map_Context_AdminEspritService', true],
            'security.firewall.map.context.admin_fac' => ['privates', 'security.firewall.map.context.admin_fac', 'getSecurity_Firewall_Map_Context_AdminFacService', true],
            'security.firewall.map.context.etudiant_esprit' => ['privates', 'security.firewall.map.context.etudiant_esprit', 'getSecurity_Firewall_Map_Context_EtudiantEspritService', true],
            ...
            'security.firewall.map.context.admin_esprit' => '?',
            'security.firewall.map.context.admin_fac' => '?',
            'security.firewall.map.context.etudiant_esprit' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uoRuC2oOg8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wTJrd5L5n4', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V44qUHjPAv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x+EiWV603p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VnhjTM8z+S', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AulS5KvttK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.app_adminfac_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppAdminfacProviderService'));
            yield 1 => ($this->privates['security.user.provider.concrete.app_admines_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppAdminesProviderService'));
            yield 2 => ($this->privates['security.user.provider.concrete.app_etudiantes_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppEtudiantesProviderService'));
        }, 3), 'admin_fac', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.admin_fac'] ?? $this->getSecurity_EventDispatcher_AdminFacService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->services['.container.private.security.token_storage'] ?? $this->get_Container_Private_Security_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_ContextListener_1Service()
    {
        return $this->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.app_admines_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppAdminesProviderService'));
            yield 2 => ($this->privates['security.user.provider.concrete.app_etudiantes_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppEtudiantesProviderService'));
        }, 3), 'admin_esprit', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.admin_esprit'] ?? $this->getSecurity_EventDispatcher_AdminEspritService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->services['.container.private.security.token_storage'] ?? $this->get_Container_Private_Security_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_ContextListener_2Service()
    {
        return $this->privates['security.context_listener.2'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.app_admines_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppAdminesProviderService'));
            yield 2 => ($this->privates['security.user.provider.concrete.app_etudiantes_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppEtudiantesProviderService'));
        }, 3), 'etudiant_esprit', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.etudiant_esprit'] ?? $this->getSecurity_EventDispatcher_EtudiantEspritService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->services['.container.private.security.token_storage'] ?? $this->get_Container_Private_Security_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    /**
     * Gets the private 'security.event_dispatcher.admin_esprit' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_AdminEspritService()
    {
        $this->privates['security.event_dispatcher.admin_esprit'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.admin_esprit.user_provider'] ?? $this->load('getSecurity_Listener_AdminEsprit_UserProviderService'));
        }, 1 => 'checkPassport'], 2048);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.admin_esprit'] ?? $this->load('getSecurity_Listener_Session_AdminEspritService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () {
            return ($this->privates['security.logout.listener.default.admin_esprit'] ?? $this->load('getSecurity_Logout_Listener_Default_AdminEspritService'));
        }, 1 => 'onLogout'], 64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () {
            return ($this->privates['security.logout.listener.session.admin_esprit'] ?? ($this->privates['security.logout.listener.session.admin_esprit'] = new \Symfony\Component\Security\Http\EventListener\SessionLogoutListener()));
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.check_remember_me_conditions.admin_esprit'] ?? $this->load('getSecurity_Listener_CheckRememberMeConditions_AdminEspritService'));
        }, 1 => 'onSuccessfulLogin'], -32);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.remember_me.admin_esprit'] ?? $this->load('getSecurity_Listener_RememberMe_AdminEspritService'));
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.admin_esprit'] ?? $this->load('getSecurity_Listener_UserChecker_AdminEspritService'));
    ...
    /**
     * Gets the private 'security.event_dispatcher.admin_fac' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_AdminFacService()
    {
        $this->privates['security.event_dispatcher.admin_fac'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.admin_fac.user_provider'] ?? $this->load('getSecurity_Listener_AdminFac_UserProviderService'));
        }, 1 => 'checkPassport'], 2048);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.admin_fac'] ?? $this->load('getSecurity_Listener_Session_AdminFacService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () {
            return ($this->privates['security.logout.listener.default.admin_fac'] ?? $this->load('getSecurity_Logout_Listener_Default_AdminFacService'));
        }, 1 => 'onLogout'], 64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () {
            return ($this->privates['security.logout.listener.session.admin_fac'] ?? ($this->privates['security.logout.listener.session.admin_fac'] = new \Symfony\Component\Security\Http\EventListener\SessionLogoutListener()));
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.check_remember_me_conditions.admin_fac'] ?? $this->load('getSecurity_Listener_CheckRememberMeConditions_AdminFacService'));
        }, 1 => 'onSuccessfulLogin'], -32);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.remember_me.admin_fac'] ?? $this->load('getSecurity_Listener_RememberMe_AdminFacService'));
        }, 1 => 'onSuccessfulLogin'], -64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginFailureEvent', [0 => function () {
            return ($this->privates['security.listener.remember_me.admin_fac'] ?? $this->load('getSecurity_Listener_RememberMe_AdminFacService'));
        }, 1 => 'clearCookie'], 0);
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.admin_fac'] ?? $this->load('getSecurity_Listener_UserChecker_AdminFacService'));
        }, 1 => 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [0 => function () {
            return ($this->privates['security.listener.user_checker.admin_fac'] ?? $this->load('getSecurity_Listener_UserChecker_AdminFacService'));
        }, 1 => 'postCheckCredentials'], 256);
    ...
    /**
     * Gets the private 'security.event_dispatcher.etudiant_esprit' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_EtudiantEspritService()
    {
        $this->privates['security.event_dispatcher.etudiant_esprit'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.etudiant_esprit.user_provider'] ?? $this->load('getSecurity_Listener_EtudiantEsprit_UserProviderService'));
        }, 1 => 'checkPassport'], 2048);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.etudiant_esprit'] ?? $this->load('getSecurity_Listener_Session_EtudiantEspritService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () {
            return ($this->privates['security.logout.listener.default.etudiant_esprit'] ?? $this->load('getSecurity_Logout_Listener_Default_EtudiantEspritService'));
        }, 1 => 'onLogout'], 64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LogoutEvent', [0 => function () {
            return ($this->privates['security.logout.listener.session.etudiant_esprit'] ?? ($this->privates['security.logout.listener.session.etudiant_esprit'] = new \Symfony\Component\Security\Http\EventListener\SessionLogoutListener()));
        }, 1 => 'onLogout'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.check_remember_me_conditions.etudiant_esprit'] ?? $this->load('getSecurity_Listener_CheckRememberMeConditions_EtudiantEspritService'));
        }, 1 => 'onSuccessfulLogin'], -32);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.remember_me.etudiant_esprit'] ?? $this->load('getSecurity_Listener_RememberMe_EtudiantEspritService'));
        }, 1 => 'onSuccessfulLogin'], -64);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginFailureEvent', [0 => function () {
            return ($this->privates['security.listener.remember_me.etudiant_esprit'] ?? $this->load('getSecurity_Listener_RememberMe_EtudiantEspritService'));
        }, 1 => 'clearCookie'], 0);
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.etudiant_esprit'] ?? $this->load('getSecurity_Listener_UserChecker_EtudiantEspritService'));
        }, 1 => 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [0 => function () {
            return ($this->privates['security.listener.user_checker.etudiant_esprit'] ?? $this->load('getSecurity_Listener_UserChecker_EtudiantEspritService'));
        }, 1 => 'postCheckCredentials'], 256);
    ...
    {
        $a = ($this->privates['.service_locator.DWP.fe3'] ?? $this->get_ServiceLocator_DWP_Fe3Service());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            yield 'security.firewall.map.context.admin_fac' => ($this->privates['.security.request_matcher.hyrKDQ0'] ?? ($this->privates['.security.request_matcher.hyrKDQ0'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/loginFac')));
            yield 'security.firewall.map.context.admin_esprit' => ($this->privates['.security.request_matcher.aeb3C1Q'] ?? ($this->privates['.security.request_matcher.aeb3C1Q'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/loginEs')));
            yield 'security.firewall.map.context.etudiant_esprit' => ($this->privates['.security.request_matcher.HiaUemK'] ?? ($this->privates['.security.request_matcher.HiaUemK'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/loginEtudiant')));
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('admin_fac', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
        $instance->registerListener('admin_esprit', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
        $instance->registerListener('etudiant_esprit', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
