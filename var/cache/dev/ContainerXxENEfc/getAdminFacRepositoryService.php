 ...
 */
class getAdminFacRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AdminFacRepository' shared autowired service.
     *
     * @return \App\Repository\AdminFacRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AdminFacRepository.php';

        return $container->privates['App\\Repository\\AdminFacRepository'] = new \App\Repository\AdminFacRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
