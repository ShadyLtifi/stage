...
class getSecurity_UserProvidersService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user_providers'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.app_adminfac_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppAdminfacProviderService'));
            yield 1 => ($container->privates['security.user.provider.concrete.app_admines_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppAdminesProviderService'));
            yield 2 => ($container->privates['security.user.provider.concrete.app_etudiantes_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppEtudiantesProviderService'));
        }, 3));
    }
}
