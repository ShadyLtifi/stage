 ...
 */
class getEtudiantAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\EtudiantAuthenticator' shared autowired service.
     *
     * @return \App\Security\EtudiantAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'EtudiantAuthenticator.php';

        return $container->privates['App\\Security\\EtudiantAuthenticator'] = new \App\Security\EtudiantAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
